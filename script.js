...
if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream){document.body.innerHTML+='<div style="display:table-cell;background-color:black;color:white;text-align:center;vertical-align:middle;position:fixed;top:0;left:0;right:0;bottom:0;width:100%;height:100%;margin:0;padding:0;border:0;" onclick="window.getData();this.outerHTML=\'\';"><div style="display:table-cell;text-align:center;vertical-align:middle;color:white;">Tap the screen to continue...</div></div>';}
