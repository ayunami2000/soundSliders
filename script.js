...
document.querySelectorAll('input[name=preset]')[i].hasChanged=0;
document.querySelectorAll('input[name=preset]')[i].onchange=function(){this.hasChanged=1;if(this.checked){document.querySelector('input[type=range]').value=document.querySelector('input[type=number]').value=this.value;window.getData();}}
document.querySelectorAll('input[name=preset]')[i].onclick=function(){if(this.hasChanged){this.hasChanged=0;window.getData();}}
}
