...
document.body.innerHTML='<h1>soundSliders</h1><h3>Choose a Slider:</h3><ul><li><a href="#custom">Custom audio</a></li><li>Noteblock<ul><li><a href="#noteblock/bass">Bass</a></li><li><a href="#noteblock/bassattack">Bass attack (guitar)</a></li><li><a href="#noteblock/bassdrum">Bass drum</a></li><li><a href="#noteblock/snare">Snare drum</a></li><li><a href="#noteblock/harp">Harp (piano)</a></li><li><a href="#noteblock/pling">Pling (piano 2)</a></li><li><a href="#noteblock/hat">Hat (click)</a></li></ul></li><li><a href="#deadly lazer">The Sun is a Deadly Lazer</a></li><li><a href="#noot">Noot</a></li><li><a href="#ting">Da Ting Go Skrra</a></li><li><a href="#spaghet">Spaghet</a></li><li><a href="#da wae">Da wae</a></li><li><a href="#oof">Oof</a></li><li><a href="#woah">Woah</a></li><li><a href="#yee">Yee</a></li><li><a href="#bork">Bork</a></li><li><a href="#toad">Toad</a></li></ul>';
}else{
