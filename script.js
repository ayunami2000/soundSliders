...
document.querySelectorAll('input[name=preset]')[i].nextElementSibling.nextElementSibling.onclick=function(){if(this.previousElementSibling.previousElementSibling.checked){document.querySelector('input[type=range]').value=document.querySelector('input[type=number]').value=this.previousElementSibling.previousElementSibling.value;}window.getData();}
}
