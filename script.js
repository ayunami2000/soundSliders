...
req.open('GET',"sounds/"+window.location.hash.slice(1).replace(/(?![\w\s])./g,'')+"/the.mp3",true);//\W
...
document.body.innerHTML='<h1>soundSliders</h1><h3>Choose a Slider:</h3><ul><li><a href="#custom">Custom audio</a></li><li><a href="#spaghet">Spaghet</a></li><li><a href="#da wae">Da wae</a></li><li><a href="#oof">Oof</a></li><li><a href="#woah">Woah</a></li><li><a href="#yee">Yee</a></li><li><a href="#bork">Bork</a></li><li><a href="#toad">Toad</a></li></ul>';
}else{
