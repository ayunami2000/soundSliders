...
if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream){document.body.innerHTML+='<div style="background-color:black;color:white;text-align:center;vertical-align:middle;position:fixed;top:0;left:0;right:0;bottom:0;width:100%;height:100%;margin:0;padding:0;border:0;" onclick="window.getData();alert(\'Audio has been enabled!\');this.outerHTML=\'\';"><span style="display:table-cell;text-align:center;vertical-align:middle;color:white;">Tap the screen to continue...</span></div>';}
