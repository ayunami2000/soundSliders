...
document.querySelectorAll('input[name=preset]')[i].onclick=document.querySelectorAll('input[name=preset]')[i].nextElementSibling.nextElementSibling.onclick=function(){window.getData();}
}
