...
document.onkeypress=function(e){var charCode=(typeof e.which=="number")?e.which:e.keyCode;console.log(charCode);(charCode==65)?document.querySelectorAll('input[name=preset]')[0].parentElement.onmousedown():(charCode==83)?document.querySelectorAll('input[name=preset]')[1].parentElement.onmousedown():(charCode==68)?document.querySelectorAll('input[name=preset]')[2].parentElement.onmousedown():(charCode==74)?document.querySelectorAll('input[name=preset]')[3].parentElement.onmousedown():(charCode==75)?document.querySelectorAll('input[name=preset]')[4].parentElement.onmousedown():(charCode==76)&&document.querySelectorAll('input[name=preset]')[5].parentElement.onmousedown();}
