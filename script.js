...
document.querySelectorAll('button')[1].onclick=function(){document.querySelectorAll('input[name=preset]')[this.nextElementSibling.value].nextElementSibling.nextElementSibling.value=document.querySelectorAll('input[name=preset]')[this.nextElementSibling.value].value=document.querySelector('input[type=range]').value;for(var i=0;i<document.querySelectorAll('input[name=preset]').length;i++){document.querySelectorAll('input[name=preset]')[i].checked=i==this.nextElementSibling.value;}}
