...
document.body.innerHTML+="<img id='btn' src='sounds/"+window.location.hash.slice(1).replace(/\W/g,'')+"/"+window.location.hash.slice(1).replace(/\W/g,'')+".mp3' style='cursor:pointer;width:10em;height:10em;'/>";
