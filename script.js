...
for(var i=0;i<document.querySelectorAll('input[type=radio]').length;i++){document.querySelectorAll('input[type=radio]')[i].onchange=function(){if(this.checked){document.querySelector('input[type=range]').value=this.value;window.getData();}}}
//document.querySelectorAll('button')[1].onclick=function(){for(var i=0;i<document.querySelectorAll('input[type=radio]').length;i++){}}
