...
document.body.onkeypress=function(e){if(e.keyCode==65){document.querySelectorAll('input[name=preset]')[0].parentElement.onmousedown();}if(e.keyCode==83){document.querySelectorAll('input[name=preset]')[1].parentElement.onmousedown();}if(e.keyCode==68){document.querySelectorAll('input[name=preset]')[2].parentElement.onmousedown();}if(e.keyCode==74){document.querySelectorAll('input[name=preset]')[3].parentElement.onmousedown();}if(e.keyCode==75){document.querySelectorAll('input[name=preset]')[4].parentElement.onmousedown();}if(e.keyCode==76){document.querySelectorAll('input[name=preset]')[5].parentElement.onmousedown();}}
